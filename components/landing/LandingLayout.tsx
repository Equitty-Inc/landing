...
export default function LandingLayout({ locale, onSubmitWaitlist }: Props) {
  ...
  const t = {
    en: {
      ...
      desc: "Be one of the first to see the tool that turns real assets into simple, transparent, accessible investments.",
    ...
    es: {
      ...
      h1b: "Activos Reales",
      desc: "Sé de los primeros en ver la herramienta que convierte activos reales en inversiones simples, transparentes y accesibles.",
